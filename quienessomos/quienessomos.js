    ...
    fetch('../navbar/navbar.html')
        ...
        .then(html => {
            ...
            navLinks.forEach(link => {
                if (link.getAttribute('href') === '../quienes-somos/quienessomos.html' || 
                    link.textContent.trim().toLowerCase() === 'quiénes somos') {
...
window.addEventListener('error', (e) => {
    console.error('Error en quienessomos.js:', e.error);
});
